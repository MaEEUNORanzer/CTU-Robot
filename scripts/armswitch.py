    ...
    def _start_init_async(self, r):
        ...
        def _init_task():
            try:
                ...
                DOWriter.write_once(0, True)
                DOWriter.write_once(2, True)
                
                time.sleep(0.1)
                
                DOWriter.write_once(0, False)
                DOWriter.write_once(2, False)

                time.sleep(1.0)

                DOWriter.write_once(1, True)
                DOWriter.write_once(3, True)
                
                time.sleep(0.1)
                
                DOWriter.write_once(1, False)
                DOWriter.write_once(3, False)
